...
class BaseApi(api_client.Api):
    ...
    def _get_single_record_mapped_args(
        ...
        system_id2: typing.Optional[str] = None,
        ...
        if system_id2 is not None:
            _query_params["systemId"] = system_id2
    ...
    async def _aget_single_record_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/personnel/v1/employee-job-history-details/{systemId}',
            auth_settings=_auth,
            headers=_headers,
        )
