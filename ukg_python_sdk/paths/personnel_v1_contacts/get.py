...
class BaseApi(api_client.Api):
    ...
    def _get_personnel_details_mapped_args(
        self,
    ...
    async def _aget_personnel_details_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/personnel/v1/contacts',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_personnel_details_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetPersonnelDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_personnel_details(
        self,
        employee_id: typing.Optional[str] = None,
        is_active: typing.Optional[str] = None,
        relationship_code: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_personnel_details_mapped_args(
        ...
        return await self._aget_personnel_details_oapg(
    ...
    def get_personnel_details(
        ...
        return self._get_personnel_details_oapg(
            query_params=args.query,
        )

class GetPersonnelDetails(BaseApi):
    ...
    async def aget_personnel_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_personnel_details(
            employee_id=employee_id,
            is_active=is_active,
            relationship_code=relationship_code,
            contact_id=contact_id,
    ...
    def get_personnel_details(
        ...
        raw_response = self.raw.get_personnel_details(
            employee_id=employee_id,
            is_active=is_active,
            relationship_code=relationship_code,
            contact_id=contact_id,
