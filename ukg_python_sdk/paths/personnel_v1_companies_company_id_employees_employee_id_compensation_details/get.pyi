...
from ukg_python_sdk.model.compensation_details_get_by_company_and_employee200_response import CompensationDetailsGetByCompanyAndEmployee200Response as CompensationDetailsGetByCompanyAndEmployee200ResponseSchema
from ukg_python_sdk.model.compensation_details_get_by_company_and_employee500_response import CompensationDetailsGetByCompanyAndEmployee500Response as CompensationDetailsGetByCompanyAndEmployee500ResponseSchema
from ukg_python_sdk.model.compensation_details_get_by_company_and_employee_response import CompensationDetailsGetByCompanyAndEmployeeResponse as CompensationDetailsGetByCompanyAndEmployeeResponseSchema

from ukg_python_sdk.type.compensation_details_get_by_company_and_employee200_response import CompensationDetailsGetByCompanyAndEmployee200Response
from ukg_python_sdk.type.compensation_details_get_by_company_and_employee500_response import CompensationDetailsGetByCompanyAndEmployee500Response
from ukg_python_sdk.type.compensation_details_get_by_company_and_employee_response import CompensationDetailsGetByCompanyAndEmployeeResponse

from ...api_client import Dictionary
from ukg_python_sdk.pydantic.compensation_details_get_by_company_and_employee_response import CompensationDetailsGetByCompanyAndEmployeeResponse as CompensationDetailsGetByCompanyAndEmployeeResponsePydantic
from ukg_python_sdk.pydantic.compensation_details_get_by_company_and_employee500_response import CompensationDetailsGetByCompanyAndEmployee500Response as CompensationDetailsGetByCompanyAndEmployee500ResponsePydantic
from ukg_python_sdk.pydantic.compensation_details_get_by_company_and_employee200_response import CompensationDetailsGetByCompanyAndEmployee200Response as CompensationDetailsGetByCompanyAndEmployee200ResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = CompensationDetailsGetByCompanyAndEmployeeResponseSchema
SchemaFor200ResponseBodyTextJson = CompensationDetailsGetByCompanyAndEmployee200ResponseSchema
SchemaFor200ResponseBodyApplicationProblemjson = CompensationDetailsGetByCompanyAndEmployee200ResponseSchema
SchemaFor200ResponseBodyApplicationXml = CompensationDetailsGetByCompanyAndEmployee200ResponseSchema
SchemaFor200ResponseBodyTextXml = CompensationDetailsGetByCompanyAndEmployee200ResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CompensationDetailsGetByCompanyAndEmployeeResponse
...
SchemaFor500ResponseBodyApplicationJson = CompensationDetailsGetByCompanyAndEmployee500ResponseSchema
SchemaFor500ResponseBodyTextJson = CompensationDetailsGetByCompanyAndEmployee500ResponseSchema
SchemaFor500ResponseBodyApplicationProblemjson = CompensationDetailsGetByCompanyAndEmployee500ResponseSchema
SchemaFor500ResponseBodyApplicationXml = CompensationDetailsGetByCompanyAndEmployee500ResponseSchema
SchemaFor500ResponseBodyTextXml = CompensationDetailsGetByCompanyAndEmployee500ResponseSchema


@dataclass
class ApiResponseFor500(api_client.ApiResponse):
    body: CompensationDetailsGetByCompanyAndEmployee500Response
...
class BaseApi(api_client.Api):
    ...
    def _get_by_company_and_employee_mapped_args(
        self,
        company_id: str,
        employee_id: str,
    ...
    async def _aget_by_company_and_employee_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/personnel/v1/companies/{companyId}/employees/{employeeId}/compensation-details',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_by_company_and_employee_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetByCompanyAndEmployeeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_company_and_employee(
        self,
        company_id: str,
        employee_id: str,
        company_id2: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_by_company_and_employee_mapped_args(
        ...
        return await self._aget_by_company_and_employee_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_by_company_and_employee(
        self,
        company_id: str,
        employee_id: str,
        company_id2: typing.Optional[str] = None,
        ...
        return self._get_by_company_and_employee_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetByCompanyAndEmployee(BaseApi):
    ...
    async def aget_by_company_and_employee(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CompensationDetailsGetByCompanyAndEmployeeResponsePydantic:
        raw_response = await self.raw.aget_by_company_and_employee(
            company_id=company_id,
            employee_id=employee_id,
            company_id2=company_id2,
            employee_id2=employee_id2,
        ...
        if validate:
            return RootModel[CompensationDetailsGetByCompanyAndEmployeeResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(CompensationDetailsGetByCompanyAndEmployeeResponsePydantic, raw_response.body)
    ...
    def get_by_company_and_employee(
        ...
        raw_response = self.raw.get_by_company_and_employee(
            company_id=company_id,
            employee_id=employee_id,
            company_id2=company_id2,
            employee_id2=employee_id2,
