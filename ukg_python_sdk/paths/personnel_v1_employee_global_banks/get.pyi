...
from ukg_python_sdk.model.employee_global_banks_model import EmployeeGlobalBanksModel as EmployeeGlobalBanksModelSchema

from ukg_python_sdk.type.employee_global_banks_model import EmployeeGlobalBanksModel

from ...api_client import Dictionary
from ukg_python_sdk.pydantic.employee_global_banks_model import EmployeeGlobalBanksModel as EmployeeGlobalBanksModelPydantic

# Query params
CompanyIdSchema = schemas.StrSchema
EmployeeIdSchema = schemas.StrSchema
EmployeeCountrySchema = schemas.StrSchema
PayGroupSchema = schemas.StrSchema
DateModifiedSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'employeeCountry': typing.Union[EmployeeCountrySchema, str, ],
        'payGroup': typing.Union[PayGroupSchema, str, ],
        'dateModified': typing.Union[DateModifiedSchema, str, ],
...
request_query_employee_country = api_client.QueryParameter(
    name="employeeCountry",
    style=api_client.ParameterStyle.FORM,
    schema=EmployeeCountrySchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = EmployeeGlobalBanksModelSchema
SchemaFor200ResponseBodyTextJson = EmployeeGlobalBanksModelSchema
SchemaFor200ResponseBodyApplicationProblemjson = EmployeeGlobalBanksModelSchema
SchemaFor200ResponseBodyApplicationXml = EmployeeGlobalBanksModelSchema
SchemaFor200ResponseBodyTextXml = EmployeeGlobalBanksModelSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EmployeeGlobalBanksModel
...
class BaseApi(api_client.Api):
    ...
    def _get_mapped_args(
        ...
        employee_country: typing.Optional[str] = None,
        ...
        if employee_country is not None:
            _query_params["employeeCountry"] = employee_country
        if pay_group is not None:
            _query_params["payGroup"] = pay_group
        if date_modified is not None:
            _query_params["dateModified"] = date_modified
        if page is not None:
    ...
    async def _aget_oapg(
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_employee_country,
        ...
        request_before_hook(
            ...
            path_template='/personnel/v1/employee-global-banks',
            auth_settings=_auth,
            headers=_headers,
        )
...
class Get(BaseApi):
    ...
    async def aget(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmployeeGlobalBanksModelPydantic:
        ...
        if validate:
            return EmployeeGlobalBanksModelPydantic(**raw_response.body)
        return api_client.construct_model_instance(EmployeeGlobalBanksModelPydantic, raw_response.body)
