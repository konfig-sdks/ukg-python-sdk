...
from ukg_python_sdk.model.employee_pay_deduction_elements_model import EmployeePayDeductionElementsModel as EmployeePayDeductionElementsModelSchema

from ukg_python_sdk.type.employee_pay_deduction_elements_model import EmployeePayDeductionElementsModel

from ...api_client import Dictionary
from ukg_python_sdk.pydantic.employee_pay_deduction_elements_model import EmployeePayDeductionElementsModel as EmployeePayDeductionElementsModelPydantic
...
PayDeductionNameSchema = schemas.StrSchema
PeriodStartNameSchema = schemas.StrSchema
PaymentOrDeductionIndicatorSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'payDeductionName': typing.Union[PayDeductionNameSchema, str, ],
        'periodStartName': typing.Union[PeriodStartNameSchema, str, ],
        'paymentOrDeductionIndicator': typing.Union[PaymentOrDeductionIndicatorSchema, str, ],
...
request_query_pay_deduction_name = api_client.QueryParameter(
    name="payDeductionName",
    style=api_client.ParameterStyle.FORM,
    schema=PayDeductionNameSchema,
    explode=True,
)
request_query_period_start_name = api_client.QueryParameter(
    name="periodStartName",
    style=api_client.ParameterStyle.FORM,
    schema=PeriodStartNameSchema,
    explode=True,
)
request_query_payment_or_deduction_indicator = api_client.QueryParameter(
    name="paymentOrDeductionIndicator",
    style=api_client.ParameterStyle.FORM,
    schema=PaymentOrDeductionIndicatorSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = EmployeePayDeductionElementsModelSchema
SchemaFor200ResponseBodyTextJson = EmployeePayDeductionElementsModelSchema
SchemaFor200ResponseBodyApplicationProblemjson = EmployeePayDeductionElementsModelSchema
SchemaFor200ResponseBodyApplicationXml = EmployeePayDeductionElementsModelSchema
SchemaFor200ResponseBodyTextXml = EmployeePayDeductionElementsModelSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EmployeePayDeductionElementsModel
...
class BaseApi(api_client.Api):
    ...
    def _get_mapped_args(
        ...
        pay_deduction_name: typing.Optional[str] = None,
        period_start_name: typing.Optional[str] = None,
        payment_or_deduction_indicator: typing.Optional[str] = None,
        ...
        if pay_deduction_name is not None:
            _query_params["payDeductionName"] = pay_deduction_name
        if period_start_name is not None:
            _query_params["periodStartName"] = period_start_name
        if payment_or_deduction_indicator is not None:
            _query_params["paymentOrDeductionIndicator"] = payment_or_deduction_indicator
    ...
    async def _aget_oapg(
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_pay_deduction_name,
            request_query_period_start_name,
            request_query_payment_or_deduction_indicator,
        ...
        request_before_hook(
            ...
            path_template='/personnel/v1/employee-pay-deduction-elements',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    async def aget(
        ...
        **kwargs,
        ...
        args = self._get_mapped_args(
            ...
            country=country,
            pay_group=pay_group,
            pay_deduction_name=pay_deduction_name,
            period_start_name=period_start_name,
            payment_or_deduction_indicator=payment_or_deduction_indicator,
...
class Get(BaseApi):
    ...
    async def aget(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmployeePayDeductionElementsModelPydantic:
        ...
        if validate:
            return EmployeePayDeductionElementsModelPydantic(**raw_response.body)
        return api_client.construct_model_instance(EmployeePayDeductionElementsModelPydantic, raw_response.body)
