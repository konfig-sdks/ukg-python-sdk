...
from ukg_python_sdk.model.result_dto_holiday_dto import ResultDtoHolidayDto as ResultDtoHolidayDtoSchema

from ukg_python_sdk.type.result_dto_holiday_dto import ResultDtoHolidayDto

from ...api_client import Dictionary
from ukg_python_sdk.pydantic.result_dto_holiday_dto import ResultDtoHolidayDto as ResultDtoHolidayDtoPydantic
...
SchemaFor200ResponseBodyApplicationJson = ResultDtoHolidayDtoSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ResultDtoHolidayDto
    ...
    async def _aget_all_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/simpleschedule/assigned_holidays',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        **kwargs,
        ...
        if validate:
            return ResultDtoHolidayDtoPydantic(**raw_response.body)
        return api_client.construct_model_instance(ResultDtoHolidayDtoPydantic, raw_response.body)
