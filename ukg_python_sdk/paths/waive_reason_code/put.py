...
class BaseApi(api_client.Api):
    ...
    def _update_single_configuration_mapped_args(
        self,
        code: str,
    ...
    async def _aupdate_single_configuration_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/waiveReason/{code}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_single_configuration_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UpdateSingleConfigurationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_single_configuration(
        self,
        code: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._update_single_configuration_mapped_args(
            code=code,
        )
        return await self._aupdate_single_configuration_oapg(
    ...
    def update_single_configuration(
        ...
        return self._update_single_configuration_oapg(
            path_params=args.path,
        )

class UpdateSingleConfiguration(BaseApi):
    ...
    async def aupdate_single_configuration(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_single_configuration(
            code=code,
            **kwargs,
        )
    ...
    def update_single_configuration(
        ...
        raw_response = self.raw.update_single_configuration(
            code=code,
        )
