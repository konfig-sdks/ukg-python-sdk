...
from ukg_python_sdk.model.result_dto_employee_job_dto import ResultDtoEmployeeJobDto as ResultDtoEmployeeJobDtoSchema

from ukg_python_sdk.type.result_dto_employee_job_dto import ResultDtoEmployeeJobDto

from ...api_client import Dictionary
from ukg_python_sdk.pydantic.result_dto_employee_job_dto import ResultDtoEmployeeJobDto as ResultDtoEmployeeJobDtoPydantic
...
SchemaFor200ResponseBodyApplicationJson = ResultDtoEmployeeJobDtoSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ResultDtoEmployeeJobDto
    ...
    async def _aget_all_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/simpleschedule/employee_jobs',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ResultDtoEmployeeJobDtoPydantic:
        ...
        if validate:
            return ResultDtoEmployeeJobDtoPydantic(**raw_response.body)
        return api_client.construct_model_instance(ResultDtoEmployeeJobDtoPydantic, raw_response.body)
