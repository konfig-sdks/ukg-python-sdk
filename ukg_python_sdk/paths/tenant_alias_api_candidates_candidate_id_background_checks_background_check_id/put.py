...
BackgroundCheckIdSchema = schemas.StrSchema
TenantAliasSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'candidate-id': typing.Union[CandidateIdSchema, str, ],
        'background-check-id': typing.Union[BackgroundCheckIdSchema, str, ],
...
request_path_background_check_id = api_client.PathParameter(
    name="background-check-id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=BackgroundCheckIdSchema,
    required=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _update_background_check_mapped_args(
        self,
        ...
        if background_check_id is not None:
            _path_params["background-check-id"] = background_check_id
        if tenant_alias is not None:
            _path_params["tenant-alias"] = tenant_alias
        args.path = _path_params
        return args

    async def _aupdate_background_check_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_path_background_check_id,
        ...
        request_before_hook(
            ...
            path_template='/{tenant-alias}/api/candidates/{candidate-id}/background-checks/{background-check-id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_background_check_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateBackgroundCheckRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_background_check(
        self,
        author: BackgroundChecksAuthor,
        application: BackgroundChecksApplication,
        status: str,
        ...
        **kwargs,
        ...
        args = self._update_background_check_mapped_args(
            author=author,
        ...
        return await self._aupdate_background_check_oapg(
            body=args.body,
    ...
    def update_background_check(
        ...
        return self._update_background_check_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateBackgroundCheck(BaseApi):
    ...
    async def aupdate_background_check(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_background_check(
            author=author,
            application=application,
            status=status,
            order_number=order_number,
    ...
    def update_background_check(
        ...
        raw_response = self.raw.update_background_check(
            author=author,
            application=application,
            status=status,
            order_number=order_number,
