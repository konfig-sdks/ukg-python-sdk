...
SchemaFor200ResponseBodyApplicationProblemjson = EmployeePayStatementModelSchema
SchemaFor200ResponseBodyApplicationXml = EmployeePayStatementModelSchema
SchemaFor200ResponseBodyTextXml = EmployeePayStatementModelSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_last_pay_statement_mapped_args(
        self,
    ...
    async def _aget_last_pay_statement_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/payroll/v1/employees/pay-statement/last',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_last_pay_statement_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetLastPayStatementRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_last_pay_statement(
        self,
        employee_identifier: typing.Optional[EmployeeIdentifier] = None,
        start_date: typing.Optional[datetime] = None,
        end_date: typing.Optional[datetime] = None,
        ...
        **kwargs,
        ...
        args = self._get_last_pay_statement_mapped_args(
        ...
        return await self._aget_last_pay_statement_oapg(
            body=args.body,
            **kwargs,
        )
    
    def get_last_pay_statement(
        self,
        employee_identifier: typing.Optional[EmployeeIdentifier] = None,
        start_date: typing.Optional[datetime] = None,
        end_date: typing.Optional[datetime] = None,
        ...
        return self._get_last_pay_statement_oapg(
            body=args.body,
        )

class GetLastPayStatement(BaseApi):
    ...
    async def aget_last_pay_statement(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_last_pay_statement(
            employee_identifier=employee_identifier,
            start_date=start_date,
            end_date=end_date,
            page=page,
    ...
    def get_last_pay_statement(
        ...
        raw_response = self.raw.get_last_pay_statement(
            employee_identifier=employee_identifier,
            start_date=start_date,
            end_date=end_date,
            page=page,
