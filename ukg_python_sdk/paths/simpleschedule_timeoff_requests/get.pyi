...
from ukg_python_sdk.model.result_dto_time_off_request_dto import ResultDtoTimeOffRequestDto as ResultDtoTimeOffRequestDtoSchema

from ukg_python_sdk.type.result_dto_time_off_request_dto import ResultDtoTimeOffRequestDto

from ...api_client import Dictionary
from ukg_python_sdk.pydantic.result_dto_time_off_request_dto import ResultDtoTimeOffRequestDto as ResultDtoTimeOffRequestDtoPydantic
...
SchemaFor200ResponseBodyApplicationJson = ResultDtoTimeOffRequestDtoSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ResultDtoTimeOffRequestDto
    ...
    async def _aget_all_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/simpleschedule/timeoff_requests',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ResultDtoTimeOffRequestDtoPydantic:
        ...
        if validate:
            return ResultDtoTimeOffRequestDtoPydantic(**raw_response.body)
        return api_client.construct_model_instance(ResultDtoTimeOffRequestDtoPydantic, raw_response.body)
