...
class BaseApi(api_client.Api):
    ...
    def _get_pending_transactions_mapped_args(
        self,
    ...
    async def _aget_pending_transactions_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/time/pending_clock_transactions',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_pending_transactions_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetPendingTransactionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_pending_transactions(
        self,
        emp_name: typing.Optional[str] = None,
        emp_id: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_pending_transactions_mapped_args(
            emp_name=emp_name,
            emp_id=emp_id,
        )
        return await self._aget_pending_transactions_oapg(
    ...
    def get_pending_transactions(
        ...
        return self._get_pending_transactions_oapg(
            query_params=args.query,
        )

class GetPendingTransactions(BaseApi):
    ...
    async def aget_pending_transactions(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_pending_transactions(
            emp_name=emp_name,
            emp_id=emp_id,
            **kwargs,
        )
    ...
    def get_pending_transactions(
        ...
        raw_response = self.raw.get_pending_transactions(
            emp_name=emp_name,
            emp_id=emp_id,
        )
        if validate:
