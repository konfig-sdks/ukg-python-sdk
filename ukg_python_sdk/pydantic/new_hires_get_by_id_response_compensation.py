...
from ukg_python_sdk.pydantic.new_hires_get_by_id_response_compensation_currency import NewHiresGetByIdResponseCompensationCurrency
from ukg_python_sdk.pydantic.new_hires_get_by_id_response_compensation_rate_per import NewHiresGetByIdResponseCompensationRatePer

class NewHiresGetByIdResponseCompensation(BaseModel):
    ...
    currency: typing.Optional[NewHiresGetByIdResponseCompensationCurrency] = Field(None, alias='currency')

    # Pay rate of the new hire
    pay_rate: typing.Optional[typing.Union[int, float]] = Field(None, alias='payRate')

    rate_per: typing.Optional[NewHiresGetByIdResponseCompensationRatePer] = Field(None, alias='ratePer')
