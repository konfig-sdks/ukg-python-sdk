...
from ukg_python_sdk.pydantic.new_hire_read_model_contact_information_address_country import NewHireReadModelContactInformationAddressCountry

class NewHireReadModelContactInformationAddress(BaseModel):
    ...
    country: typing.Optional[NewHireReadModelContactInformationAddressCountry] = Field(None, alias='country')
