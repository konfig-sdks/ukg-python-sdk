...
from ukg_python_sdk.pydantic.new_hires_get_by_id200_response_compensation_currency import NewHiresGetById200ResponseCompensationCurrency
from ukg_python_sdk.pydantic.new_hires_get_by_id200_response_compensation_rate_per import NewHiresGetById200ResponseCompensationRatePer

class NewHiresGetById200ResponseCompensation(BaseModel):
    ...
    currency: typing.Optional[NewHiresGetById200ResponseCompensationCurrency] = Field(None, alias='currency')

    # Pay rate of the new hire
    pay_rate: typing.Optional[typing.Union[int, float]] = Field(None, alias='payRate')

    rate_per: typing.Optional[NewHiresGetById200ResponseCompensationRatePer] = Field(None, alias='ratePer')
