...
from ukg_python_sdk.pydantic.new_hire_read_model_compensation_currency import NewHireReadModelCompensationCurrency
from ukg_python_sdk.pydantic.new_hire_read_model_compensation_rate_per import NewHireReadModelCompensationRatePer

class NewHireReadModelCompensation(BaseModel):
    ...
    currency: typing.Optional[NewHireReadModelCompensationCurrency] = Field(None, alias='currency')

    # Pay rate of the new hire
    pay_rate: typing.Optional[typing.Union[int, float]] = Field(None, alias='payRate')

    rate_per: typing.Optional[NewHireReadModelCompensationRatePer] = Field(None, alias='ratePer')
