...
class UserDetails(BaseModel):
    ...
    user_last_logon_date: typing.Optional[datetime] = Field(None, alias='userLastLogonDate')

    user_last_password_change_date: typing.Optional[datetime] = Field(None, alias='userLastPasswordChangeDate')
