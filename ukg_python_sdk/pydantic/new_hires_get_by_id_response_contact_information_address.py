...
from ukg_python_sdk.pydantic.new_hires_get_by_id_response_contact_information_address_country import NewHiresGetByIdResponseContactInformationAddressCountry

class NewHiresGetByIdResponseContactInformationAddress(BaseModel):
    ...
    country: typing.Optional[NewHiresGetByIdResponseContactInformationAddressCountry] = Field(None, alias='country')
