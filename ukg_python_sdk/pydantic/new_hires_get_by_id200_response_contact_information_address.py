...
from ukg_python_sdk.pydantic.new_hires_get_by_id200_response_contact_information_address_country import NewHiresGetById200ResponseContactInformationAddressCountry

class NewHiresGetById200ResponseContactInformationAddress(BaseModel):
    ...
    country: typing.Optional[NewHiresGetById200ResponseContactInformationAddressCountry] = Field(None, alias='country')
