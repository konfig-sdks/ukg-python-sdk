...
class RequiredNewHirePostModelCompensation(TypedDict):
    pass

class OptionalNewHirePostModelCompensation(TypedDict, total=False):
...
class NewHirePostModelCompensation(RequiredNewHirePostModelCompensation, OptionalNewHirePostModelCompensation):
    pass
