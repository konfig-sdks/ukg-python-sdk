...
class RequiredSkillProficiencyLevel(TypedDict):
    pass

class OptionalSkillProficiencyLevel(TypedDict, total=False):
...
class SkillProficiencyLevel(RequiredSkillProficiencyLevel, OptionalSkillProficiencyLevel):
    pass
