...
class RequiredNewHirePostModelContactInformationAddress(TypedDict):
    pass

class OptionalNewHirePostModelContactInformationAddress(TypedDict, total=False):
...
class NewHirePostModelContactInformationAddress(RequiredNewHirePostModelContactInformationAddress, OptionalNewHirePostModelContactInformationAddress):
    pass
