...
class NewHiresGetByIdResponseCompensation(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def currency() -> typing.Type['NewHiresGetByIdResponseCompensationCurrency']:
                return NewHiresGetByIdResponseCompensationCurrency
            payRate = schemas.NumberSchema
        
            @staticmethod
            def ratePer() -> typing.Type['NewHiresGetByIdResponseCompensationRatePer']:
                return NewHiresGetByIdResponseCompensationRatePer
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["currency"]) -> 'NewHiresGetByIdResponseCompensationCurrency': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payRate"]) -> MetaOapg.properties.payRate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ratePer"]) -> 'NewHiresGetByIdResponseCompensationRatePer': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["currency"]) -> typing.Union['NewHiresGetByIdResponseCompensationCurrency', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payRate"]) -> typing.Union[MetaOapg.properties.payRate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ratePer"]) -> typing.Union['NewHiresGetByIdResponseCompensationRatePer', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        currency: typing.Union['NewHiresGetByIdResponseCompensationCurrency', schemas.Unset] = schemas.unset,
        payRate: typing.Union[MetaOapg.properties.payRate, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        ratePer: typing.Union['NewHiresGetByIdResponseCompensationRatePer', schemas.Unset] = schemas.unset,
