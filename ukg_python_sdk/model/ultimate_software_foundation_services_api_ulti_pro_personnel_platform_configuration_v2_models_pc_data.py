...
class UltimateSoftwareFoundationServicesApiUltiProPersonnelPlatformConfigurationV2ModelsPcData(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class fieldRows(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['UltimateSoftwareFoundationServicesApiUltiProPersonnelPlatformConfigurationV2ModelsFieldData']:
                        return UltimateSoftwareFoundationServicesApiUltiProPersonnelPlatformConfigurationV2ModelsFieldData
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['UltimateSoftwareFoundationServicesApiUltiProPersonnelPlatformConfigurationV2ModelsFieldData'], typing.List['UltimateSoftwareFoundationServicesApiUltiProPersonnelPlatformConfigurationV2ModelsFieldData']],
                ...
                def __getitem__(self, i: int) -> 'UltimateSoftwareFoundationServicesApiUltiProPersonnelPlatformConfigurationV2ModelsFieldData':
