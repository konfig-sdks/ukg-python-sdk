...
class NewHiresCreateSingleNewHireResponseMentorName(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def prefix() -> typing.Type['NewHiresCreateSingleNewHireResponseMentorNamePrefix']:
                return NewHiresCreateSingleNewHireResponseMentorNamePrefix
            ...
            @staticmethod
            def suffix() -> typing.Type['NewHiresCreateSingleNewHireResponseMentorNameSuffix']:
                return NewHiresCreateSingleNewHireResponseMentorNameSuffix
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["prefix"]) -> 'NewHiresCreateSingleNewHireResponseMentorNamePrefix': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["suffix"]) -> 'NewHiresCreateSingleNewHireResponseMentorNameSuffix': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["prefix"]) -> typing.Union['NewHiresCreateSingleNewHireResponseMentorNamePrefix', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["suffix"]) -> typing.Union['NewHiresCreateSingleNewHireResponseMentorNameSuffix', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        prefix: typing.Union['NewHiresCreateSingleNewHireResponseMentorNamePrefix', schemas.Unset] = schemas.unset,
        ...
        suffix: typing.Union['NewHiresCreateSingleNewHireResponseMentorNameSuffix', schemas.Unset] = schemas.unset,
