...
class NewHireReadModelContactInformation(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def name() -> typing.Type['NewHireReadModelContactInformationName']:
                return NewHireReadModelContactInformationName
            emailAddress = schemas.StrSchema
            primaryPhone = schemas.StrSchema
            secondaryPhone = schemas.StrSchema
        
            @staticmethod
            def address() -> typing.Type['NewHireReadModelContactInformationAddress']:
                return NewHireReadModelContactInformationAddress
            __annotations__ = {
                "name": name,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["name"]) -> 'NewHireReadModelContactInformationName': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["address"]) -> 'NewHireReadModelContactInformationAddress': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["name"]) -> typing.Union['NewHireReadModelContactInformationName', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["address"]) -> typing.Union['NewHireReadModelContactInformationAddress', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        name: typing.Union['NewHireReadModelContactInformationName', schemas.Unset] = schemas.unset,
        ...
        address: typing.Union['NewHireReadModelContactInformationAddress', schemas.Unset] = schemas.unset,
