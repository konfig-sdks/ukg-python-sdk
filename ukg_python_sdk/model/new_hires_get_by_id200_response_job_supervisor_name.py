...
class NewHiresGetById200ResponseJobSupervisorName(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def prefix() -> typing.Type['NewHiresGetById200ResponseJobSupervisorNamePrefix']:
                return NewHiresGetById200ResponseJobSupervisorNamePrefix
            ...
            @staticmethod
            def suffix() -> typing.Type['NewHiresGetById200ResponseJobSupervisorNameSuffix']:
                return NewHiresGetById200ResponseJobSupervisorNameSuffix
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["prefix"]) -> 'NewHiresGetById200ResponseJobSupervisorNamePrefix': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["suffix"]) -> 'NewHiresGetById200ResponseJobSupervisorNameSuffix': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["prefix"]) -> typing.Union['NewHiresGetById200ResponseJobSupervisorNamePrefix', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["suffix"]) -> typing.Union['NewHiresGetById200ResponseJobSupervisorNameSuffix', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        prefix: typing.Union['NewHiresGetById200ResponseJobSupervisorNamePrefix', schemas.Unset] = schemas.unset,
        ...
        suffix: typing.Union['NewHiresGetById200ResponseJobSupervisorNameSuffix', schemas.Unset] = schemas.unset,
