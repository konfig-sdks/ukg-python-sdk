...
class NewHiresCreateSingleNewHireResponseJobSupervisorName(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def prefix() -> typing.Type['NewHiresCreateSingleNewHireResponseJobSupervisorNamePrefix']:
                return NewHiresCreateSingleNewHireResponseJobSupervisorNamePrefix
            ...
            @staticmethod
            def suffix() -> typing.Type['NewHiresCreateSingleNewHireResponseJobSupervisorNameSuffix']:
                return NewHiresCreateSingleNewHireResponseJobSupervisorNameSuffix
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["prefix"]) -> 'NewHiresCreateSingleNewHireResponseJobSupervisorNamePrefix': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["suffix"]) -> 'NewHiresCreateSingleNewHireResponseJobSupervisorNameSuffix': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["prefix"]) -> typing.Union['NewHiresCreateSingleNewHireResponseJobSupervisorNamePrefix', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["suffix"]) -> typing.Union['NewHiresCreateSingleNewHireResponseJobSupervisorNameSuffix', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        prefix: typing.Union['NewHiresCreateSingleNewHireResponseJobSupervisorNamePrefix', schemas.Unset] = schemas.unset,
        ...
        suffix: typing.Union['NewHiresCreateSingleNewHireResponseJobSupervisorNameSuffix', schemas.Unset] = schemas.unset,
