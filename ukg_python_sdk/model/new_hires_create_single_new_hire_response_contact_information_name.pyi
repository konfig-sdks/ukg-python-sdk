...
class NewHiresCreateSingleNewHireResponseContactInformationName(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def prefix() -> typing.Type['NewHiresCreateSingleNewHireResponseContactInformationNamePrefix']:
                return NewHiresCreateSingleNewHireResponseContactInformationNamePrefix
            ...
            @staticmethod
            def suffix() -> typing.Type['NewHiresCreateSingleNewHireResponseContactInformationNameSuffix']:
                return NewHiresCreateSingleNewHireResponseContactInformationNameSuffix
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["prefix"]) -> 'NewHiresCreateSingleNewHireResponseContactInformationNamePrefix': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["suffix"]) -> 'NewHiresCreateSingleNewHireResponseContactInformationNameSuffix': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["prefix"]) -> typing.Union['NewHiresCreateSingleNewHireResponseContactInformationNamePrefix', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["suffix"]) -> typing.Union['NewHiresCreateSingleNewHireResponseContactInformationNameSuffix', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        prefix: typing.Union['NewHiresCreateSingleNewHireResponseContactInformationNamePrefix', schemas.Unset] = schemas.unset,
        ...
        suffix: typing.Union['NewHiresCreateSingleNewHireResponseContactInformationNameSuffix', schemas.Unset] = schemas.unset,
