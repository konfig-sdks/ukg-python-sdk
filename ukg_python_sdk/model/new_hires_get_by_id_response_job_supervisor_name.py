...
class NewHiresGetByIdResponseJobSupervisorName(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def prefix() -> typing.Type['NewHiresGetByIdResponseJobSupervisorNamePrefix']:
                return NewHiresGetByIdResponseJobSupervisorNamePrefix
            ...
            @staticmethod
            def suffix() -> typing.Type['NewHiresGetByIdResponseJobSupervisorNameSuffix']:
                return NewHiresGetByIdResponseJobSupervisorNameSuffix
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["prefix"]) -> 'NewHiresGetByIdResponseJobSupervisorNamePrefix': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["suffix"]) -> 'NewHiresGetByIdResponseJobSupervisorNameSuffix': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["prefix"]) -> typing.Union['NewHiresGetByIdResponseJobSupervisorNamePrefix', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["suffix"]) -> typing.Union['NewHiresGetByIdResponseJobSupervisorNameSuffix', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        prefix: typing.Union['NewHiresGetByIdResponseJobSupervisorNamePrefix', schemas.Unset] = schemas.unset,
        ...
        suffix: typing.Union['NewHiresGetByIdResponseJobSupervisorNameSuffix', schemas.Unset] = schemas.unset,
