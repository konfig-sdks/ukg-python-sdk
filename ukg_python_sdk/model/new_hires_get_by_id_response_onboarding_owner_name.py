...
class NewHiresGetByIdResponseOnboardingOwnerName(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def prefix() -> typing.Type['NewHiresGetByIdResponseOnboardingOwnerNamePrefix']:
                return NewHiresGetByIdResponseOnboardingOwnerNamePrefix
            ...
            @staticmethod
            def suffix() -> typing.Type['NewHiresGetByIdResponseOnboardingOwnerNameSuffix']:
                return NewHiresGetByIdResponseOnboardingOwnerNameSuffix
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["prefix"]) -> 'NewHiresGetByIdResponseOnboardingOwnerNamePrefix': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["suffix"]) -> 'NewHiresGetByIdResponseOnboardingOwnerNameSuffix': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["prefix"]) -> typing.Union['NewHiresGetByIdResponseOnboardingOwnerNamePrefix', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["suffix"]) -> typing.Union['NewHiresGetByIdResponseOnboardingOwnerNameSuffix', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        prefix: typing.Union['NewHiresGetByIdResponseOnboardingOwnerNamePrefix', schemas.Unset] = schemas.unset,
        ...
        suffix: typing.Union['NewHiresGetByIdResponseOnboardingOwnerNameSuffix', schemas.Unset] = schemas.unset,
