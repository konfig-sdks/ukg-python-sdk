...
class UltimateSoftwareFoundationServicesApiUltiProPersonnelImportToolModelsFileStagingStatus(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class messages(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['UltimateSoftwareFoundationServicesApiUltiProPersonnelImportToolModelsImportMessage']:
                        return UltimateSoftwareFoundationServicesApiUltiProPersonnelImportToolModelsImportMessage
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['UltimateSoftwareFoundationServicesApiUltiProPersonnelImportToolModelsImportMessage'], typing.List['UltimateSoftwareFoundationServicesApiUltiProPersonnelImportToolModelsImportMessage']],
                ...
                def __getitem__(self, i: int) -> 'UltimateSoftwareFoundationServicesApiUltiProPersonnelImportToolModelsImportMessage':
                    return super().__getitem__(i)
        
            @staticmethod
            def childTransactionStatuses() -> typing.Type['UltimateSoftwareFoundationServicesApiUltiProPersonnelImportToolModelsFileStagingStatusChildTransactionStatuses']:
                return UltimateSoftwareFoundationServicesApiUltiProPersonnelImportToolModelsFileStagingStatusChildTransactionStatuses
            __annotations__ = {
                "stagingId": stagingId,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["childTransactionStatuses"]) -> 'UltimateSoftwareFoundationServicesApiUltiProPersonnelImportToolModelsFileStagingStatusChildTransactionStatuses': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["stagingId", "fileProcessDate", "serviceSubmittalDate", "lastRepostDate", "employeeName", "employeeNumber", "status", "transaction", "fileName", "messages", "childTransactionStatuses", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["childTransactionStatuses"]) -> typing.Union['UltimateSoftwareFoundationServicesApiUltiProPersonnelImportToolModelsFileStagingStatusChildTransactionStatuses', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["stagingId", "fileProcessDate", "serviceSubmittalDate", "lastRepostDate", "employeeName", "employeeNumber", "status", "transaction", "fileName", "messages", "childTransactionStatuses", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        childTransactionStatuses: typing.Union['UltimateSoftwareFoundationServicesApiUltiProPersonnelImportToolModelsFileStagingStatusChildTransactionStatuses', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
