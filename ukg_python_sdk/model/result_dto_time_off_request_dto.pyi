...
class ResultDtoTimeOffRequestDto(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class entities(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TimeOffRequestDto']:
                        return TimeOffRequestDto
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TimeOffRequestDto'], typing.List['TimeOffRequestDto']],
                ...
                def __getitem__(self, i: int) -> 'TimeOffRequestDto':
