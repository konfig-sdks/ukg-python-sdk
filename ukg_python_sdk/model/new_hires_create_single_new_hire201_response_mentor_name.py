...
class NewHiresCreateSingleNewHire201ResponseMentorName(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def prefix() -> typing.Type['NewHiresCreateSingleNewHire201ResponseMentorNamePrefix']:
                return NewHiresCreateSingleNewHire201ResponseMentorNamePrefix
            ...
            @staticmethod
            def suffix() -> typing.Type['NewHiresCreateSingleNewHire201ResponseMentorNameSuffix']:
                return NewHiresCreateSingleNewHire201ResponseMentorNameSuffix
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["prefix"]) -> 'NewHiresCreateSingleNewHire201ResponseMentorNamePrefix': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["suffix"]) -> 'NewHiresCreateSingleNewHire201ResponseMentorNameSuffix': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["prefix"]) -> typing.Union['NewHiresCreateSingleNewHire201ResponseMentorNamePrefix', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["suffix"]) -> typing.Union['NewHiresCreateSingleNewHire201ResponseMentorNameSuffix', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        prefix: typing.Union['NewHiresCreateSingleNewHire201ResponseMentorNamePrefix', schemas.Unset] = schemas.unset,
        ...
        suffix: typing.Union['NewHiresCreateSingleNewHire201ResponseMentorNameSuffix', schemas.Unset] = schemas.unset,
