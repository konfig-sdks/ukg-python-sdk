...
class NewHiresGetByIdResponseContactInformation(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def name() -> typing.Type['NewHiresGetByIdResponseContactInformationName']:
                return NewHiresGetByIdResponseContactInformationName
            emailAddress = schemas.StrSchema
            primaryPhone = schemas.StrSchema
            secondaryPhone = schemas.StrSchema
        
            @staticmethod
            def address() -> typing.Type['NewHiresGetByIdResponseContactInformationAddress']:
                return NewHiresGetByIdResponseContactInformationAddress
            __annotations__ = {
                "name": name,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["name"]) -> 'NewHiresGetByIdResponseContactInformationName': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["address"]) -> 'NewHiresGetByIdResponseContactInformationAddress': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["name"]) -> typing.Union['NewHiresGetByIdResponseContactInformationName', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["address"]) -> typing.Union['NewHiresGetByIdResponseContactInformationAddress', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        name: typing.Union['NewHiresGetByIdResponseContactInformationName', schemas.Unset] = schemas.unset,
        ...
        address: typing.Union['NewHiresGetByIdResponseContactInformationAddress', schemas.Unset] = schemas.unset,
