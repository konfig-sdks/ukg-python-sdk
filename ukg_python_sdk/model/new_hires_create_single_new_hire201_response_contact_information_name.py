...
class NewHiresCreateSingleNewHire201ResponseContactInformationName(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def prefix() -> typing.Type['NewHiresCreateSingleNewHire201ResponseContactInformationNamePrefix']:
                return NewHiresCreateSingleNewHire201ResponseContactInformationNamePrefix
            ...
            @staticmethod
            def suffix() -> typing.Type['NewHiresCreateSingleNewHire201ResponseContactInformationNameSuffix']:
                return NewHiresCreateSingleNewHire201ResponseContactInformationNameSuffix
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["prefix"]) -> 'NewHiresCreateSingleNewHire201ResponseContactInformationNamePrefix': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["suffix"]) -> 'NewHiresCreateSingleNewHire201ResponseContactInformationNameSuffix': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["prefix"]) -> typing.Union['NewHiresCreateSingleNewHire201ResponseContactInformationNamePrefix', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["suffix"]) -> typing.Union['NewHiresCreateSingleNewHire201ResponseContactInformationNameSuffix', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        prefix: typing.Union['NewHiresCreateSingleNewHire201ResponseContactInformationNamePrefix', schemas.Unset] = schemas.unset,
        ...
        suffix: typing.Union['NewHiresCreateSingleNewHire201ResponseContactInformationNameSuffix', schemas.Unset] = schemas.unset,
