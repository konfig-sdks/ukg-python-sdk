...
class NewHiresGetById200ResponseCompensation(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def currency() -> typing.Type['NewHiresGetById200ResponseCompensationCurrency']:
                return NewHiresGetById200ResponseCompensationCurrency
            payRate = schemas.NumberSchema
        
            @staticmethod
            def ratePer() -> typing.Type['NewHiresGetById200ResponseCompensationRatePer']:
                return NewHiresGetById200ResponseCompensationRatePer
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["currency"]) -> 'NewHiresGetById200ResponseCompensationCurrency': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payRate"]) -> MetaOapg.properties.payRate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ratePer"]) -> 'NewHiresGetById200ResponseCompensationRatePer': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["currency"]) -> typing.Union['NewHiresGetById200ResponseCompensationCurrency', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payRate"]) -> typing.Union[MetaOapg.properties.payRate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ratePer"]) -> typing.Union['NewHiresGetById200ResponseCompensationRatePer', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        currency: typing.Union['NewHiresGetById200ResponseCompensationCurrency', schemas.Unset] = schemas.unset,
        payRate: typing.Union[MetaOapg.properties.payRate, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        ratePer: typing.Union['NewHiresGetById200ResponseCompensationRatePer', schemas.Unset] = schemas.unset,
