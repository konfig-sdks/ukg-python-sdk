...
class NewHireReadModelContactInformationName(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def prefix() -> typing.Type['NewHireReadModelContactInformationNamePrefix']:
                return NewHireReadModelContactInformationNamePrefix
            ...
            @staticmethod
            def suffix() -> typing.Type['NewHireReadModelContactInformationNameSuffix']:
                return NewHireReadModelContactInformationNameSuffix
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["prefix"]) -> 'NewHireReadModelContactInformationNamePrefix': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["suffix"]) -> 'NewHireReadModelContactInformationNameSuffix': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["prefix"]) -> typing.Union['NewHireReadModelContactInformationNamePrefix', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["suffix"]) -> typing.Union['NewHireReadModelContactInformationNameSuffix', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        prefix: typing.Union['NewHireReadModelContactInformationNamePrefix', schemas.Unset] = schemas.unset,
        ...
        suffix: typing.Union['NewHireReadModelContactInformationNameSuffix', schemas.Unset] = schemas.unset,
