...
class NewHiresGetByIdResponseMentorName(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def prefix() -> typing.Type['NewHiresGetByIdResponseMentorNamePrefix']:
                return NewHiresGetByIdResponseMentorNamePrefix
            ...
            @staticmethod
            def suffix() -> typing.Type['NewHiresGetByIdResponseMentorNameSuffix']:
                return NewHiresGetByIdResponseMentorNameSuffix
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["prefix"]) -> 'NewHiresGetByIdResponseMentorNamePrefix': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["suffix"]) -> 'NewHiresGetByIdResponseMentorNameSuffix': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["prefix"]) -> typing.Union['NewHiresGetByIdResponseMentorNamePrefix', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["suffix"]) -> typing.Union['NewHiresGetByIdResponseMentorNameSuffix', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        prefix: typing.Union['NewHiresGetByIdResponseMentorNamePrefix', schemas.Unset] = schemas.unset,
        ...
        suffix: typing.Union['NewHiresGetByIdResponseMentorNameSuffix', schemas.Unset] = schemas.unset,
