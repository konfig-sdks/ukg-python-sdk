...
class NewHiresGetByIdResponseContactInformationName(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def prefix() -> typing.Type['NewHiresGetByIdResponseContactInformationNamePrefix']:
                return NewHiresGetByIdResponseContactInformationNamePrefix
            ...
            @staticmethod
            def suffix() -> typing.Type['NewHiresGetByIdResponseContactInformationNameSuffix']:
                return NewHiresGetByIdResponseContactInformationNameSuffix
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["prefix"]) -> 'NewHiresGetByIdResponseContactInformationNamePrefix': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["suffix"]) -> 'NewHiresGetByIdResponseContactInformationNameSuffix': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["prefix"]) -> typing.Union['NewHiresGetByIdResponseContactInformationNamePrefix', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["suffix"]) -> typing.Union['NewHiresGetByIdResponseContactInformationNameSuffix', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        prefix: typing.Union['NewHiresGetByIdResponseContactInformationNamePrefix', schemas.Unset] = schemas.unset,
        ...
        suffix: typing.Union['NewHiresGetByIdResponseContactInformationNameSuffix', schemas.Unset] = schemas.unset,
