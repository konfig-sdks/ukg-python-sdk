...
class NewHiresCreateSingleNewHire201ResponseCompensation(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def currency() -> typing.Type['NewHiresCreateSingleNewHire201ResponseCompensationCurrency']:
                return NewHiresCreateSingleNewHire201ResponseCompensationCurrency
            payRate = schemas.NumberSchema
        
            @staticmethod
            def ratePer() -> typing.Type['NewHiresCreateSingleNewHire201ResponseCompensationRatePer']:
                return NewHiresCreateSingleNewHire201ResponseCompensationRatePer
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["currency"]) -> 'NewHiresCreateSingleNewHire201ResponseCompensationCurrency': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payRate"]) -> MetaOapg.properties.payRate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ratePer"]) -> 'NewHiresCreateSingleNewHire201ResponseCompensationRatePer': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["currency"]) -> typing.Union['NewHiresCreateSingleNewHire201ResponseCompensationCurrency', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payRate"]) -> typing.Union[MetaOapg.properties.payRate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ratePer"]) -> typing.Union['NewHiresCreateSingleNewHire201ResponseCompensationRatePer', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        currency: typing.Union['NewHiresCreateSingleNewHire201ResponseCompensationCurrency', schemas.Unset] = schemas.unset,
        payRate: typing.Union[MetaOapg.properties.payRate, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        ratePer: typing.Union['NewHiresCreateSingleNewHire201ResponseCompensationRatePer', schemas.Unset] = schemas.unset,
