...
class NewHiresGetByIdResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def contactInformation() -> typing.Type['NewHiresGetByIdResponseContactInformation']:
                return NewHiresGetByIdResponseContactInformation
        
            @staticmethod
            def job() -> typing.Type['NewHiresGetByIdResponseJob']:
                return NewHiresGetByIdResponseJob
        
            @staticmethod
            def organizationLevels() -> typing.Type['NewHiresGetByIdResponseOrganizationLevels']:
                return NewHiresGetByIdResponseOrganizationLevels
        
            @staticmethod
            def compensation() -> typing.Type['NewHiresGetByIdResponseCompensation']:
                return NewHiresGetByIdResponseCompensation
        
            @staticmethod
            def onboardingOwner() -> typing.Type['NewHiresGetByIdResponseOnboardingOwner']:
                return NewHiresGetByIdResponseOnboardingOwner
            ...
            @staticmethod
            def mentor() -> typing.Type['NewHiresGetByIdResponseMentor']:
                return NewHiresGetByIdResponseMentor
            personalMessage = schemas.StrSchema
        
            @staticmethod
            def provisioning() -> typing.Type['NewHiresGetByIdResponseProvisioning']:
                return NewHiresGetByIdResponseProvisioning
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["contactInformation"]) -> 'NewHiresGetByIdResponseContactInformation': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["job"]) -> 'NewHiresGetByIdResponseJob': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["organizationLevels"]) -> 'NewHiresGetByIdResponseOrganizationLevels': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["compensation"]) -> 'NewHiresGetByIdResponseCompensation': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["onboardingOwner"]) -> 'NewHiresGetByIdResponseOnboardingOwner': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["mentor"]) -> 'NewHiresGetByIdResponseMentor': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["personalMessage"]) -> MetaOapg.properties.personalMessage: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["provisioning"]) -> 'NewHiresGetByIdResponseProvisioning': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["contactInformation"]) -> typing.Union['NewHiresGetByIdResponseContactInformation', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["job"]) -> typing.Union['NewHiresGetByIdResponseJob', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["organizationLevels"]) -> typing.Union['NewHiresGetByIdResponseOrganizationLevels', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["compensation"]) -> typing.Union['NewHiresGetByIdResponseCompensation', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["onboardingOwner"]) -> typing.Union['NewHiresGetByIdResponseOnboardingOwner', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["mentor"]) -> typing.Union['NewHiresGetByIdResponseMentor', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["provisioning"]) -> typing.Union['NewHiresGetByIdResponseProvisioning', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        contactInformation: typing.Union['NewHiresGetByIdResponseContactInformation', schemas.Unset] = schemas.unset,
        job: typing.Union['NewHiresGetByIdResponseJob', schemas.Unset] = schemas.unset,
        organizationLevels: typing.Union['NewHiresGetByIdResponseOrganizationLevels', schemas.Unset] = schemas.unset,
        compensation: typing.Union['NewHiresGetByIdResponseCompensation', schemas.Unset] = schemas.unset,
        onboardingOwner: typing.Union['NewHiresGetByIdResponseOnboardingOwner', schemas.Unset] = schemas.unset,
        ...
        mentor: typing.Union['NewHiresGetByIdResponseMentor', schemas.Unset] = schemas.unset,
        personalMessage: typing.Union[MetaOapg.properties.personalMessage, str, schemas.Unset] = schemas.unset,
        provisioning: typing.Union['NewHiresGetByIdResponseProvisioning', schemas.Unset] = schemas.unset,
