...
class ResultDtoWorkbrainTeamDto(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class entities(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['WorkbrainTeamDto']:
                        return WorkbrainTeamDto
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['WorkbrainTeamDto'], typing.List['WorkbrainTeamDto']],
                ...
                def __getitem__(self, i: int) -> 'WorkbrainTeamDto':
